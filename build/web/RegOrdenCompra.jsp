        ...
        <div class="container">
            ...
            <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group row">
                                    <label  class="col-form-label col-sm-4">Direccion de Entreg:</label>
                                    <div class="col-sm-8"> 
                        ...
                        <div class="card-body">
                            ...
                            <div class="btns">
                                <div class="form-group d-flex" style="justify-content:center; text-align: center;">
                                    <div class="col-sm-2">
                                        <button type="submit" class="btn btn-info" value="Adicionar" name="accion">Adicionar</button> 
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="submit" class="btn btn-info" value="Ingresar a Movimientos" >
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-sm-10" style="margin: auto" >
                <table class="table table-striped table caption-top table table-bordered border-secondary">
                    <caption>Reporte de Entrada</caption>
