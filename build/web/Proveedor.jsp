                        ...
                        <div class="modal-body">
                            <div class="card-body" align="center">
                                <form action="Controlador?menu=Proveedor" method="POST">
                                    ...
                                    <button type="button" name="accion" value="Agregar" class="btn btn-danger"/>Agregar<span style="margin-left: 5px">
                                            <img src="img/add.png" height="20px" width="20px"/>
                                        </span></button>
                                    <button type="button" name="accion" value="Actualizar" class="btn btn-secondary"/>Actualizar<span style="margin-left: 5px">
