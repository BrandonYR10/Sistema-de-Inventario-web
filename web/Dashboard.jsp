...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <label class ="display-1" style="color:blue;font-family: Roboto;font-size: 50px;">Dashboard</label>
    ...
    style="
      ...
      );" class="mask col-sm p-3 mb-2 bg-success text-white">
      ...
      background: linear-gradient(
        ...
        rgba(0, 183, 74, 0.78),
        rgba(91, 14, 214, 0.5) 100%
      );" class="col-sm p-3 mb-2 bg-info text-white">
      ...
      background: linear-gradient(
        ...
        rgba(29, 236, 197, 0.5),
        rgba(91, 14, 214, 0.5) 100%
      );"  class="col-sm p-3 mb-2 bg-primary text-white">
      ...
      background: linear-gradient(
        ...
        rgba(249, 49, 84, 0.34)
        60%
      );"  class="col-sm p-3 mb-2 bg-danger text-white">
                  ...
                  <div class="container">
                      <div class ="row">
                          <div class ="col-6">
                              <img style="margin-top: 100px;" src="img/img_grafico.jpg" width="350px" alt=""/>
                          </div>
                          <div class ="col-6">
                              <img style="margin-top: 100px;" src="img/estadistica.jpg" width="350px" alt=""/>
                          </div>
                      </div>
